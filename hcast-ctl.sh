...
cd ./pre_driver
date
sh wrf_hcast_driver.sh $STRT_DATE_PACK $END_DATE_PACK $INIT_RUN_FLAG $NJORD_ROOT
sh roms_hcast_driver.sh $NJORD_PROJ_PATH $RA_ROOT $STRT_DATE_FULL $ROMS_DT $CASE_NAME
