...
def main():
    ...
    url_base='https://ncss.hycom.org/thredds/ncss/GLBy0.08/expt_93.0/FMRC/runs/GLBy0.08_930_FMRC_RUN_'+int_time_obj.strftime('%Y-%m-%d')+'T'+int_time_obj.strftime('%H')+':00:00Z?'
