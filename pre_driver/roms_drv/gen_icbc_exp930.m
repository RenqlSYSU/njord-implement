...
ocn_ra= '/public1/home/cqair/pathop/njord/drv_field//hycom_subset/2022011912/';
...
wdr = '/public1/home/cqair/pathop/njord/drv_field//icbc/2022011912/';
...
roms_swan_grid_dir = '/public1/home/cqair/pathop/njord/workspace/njord_pipeline/implement/domaindb/njord_9km3km/';

% (4) Enter path and name of the ROMS grid
%modelgrid = [roms_swan_grid_dir,'roms_',domain_str,'_lp0d1.nc'];
modelgrid = [roms_swan_grid_dir,'roms_d01_lp0d1.nc'];
...
[gn, clm]=get_ijrg_exp930([ocn_ra,'hycom.grid.exp930.nc'], modelgrid, theta_s, theta_b, Tcline, N, Vtransform, Vstretching);

% Call to create the climatology (clm) file
disp('going to create clm file')
fn=updatclim_coawst_mw_local_exp930(T1, gn, clm, 'coawst_clm.nc', wdr, ocn_ra)
